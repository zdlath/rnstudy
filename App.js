...
import {default as LinkingScreen} from './src/screen//linking/LinkingScreen';
    ...
    <Provider store={store}>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="HomeScreen">
          ...
          <Stack.Screen
            name="PassingParameterScreen"
            component={PassingParameterScreen}
          />
          ...
          <Stack.Screen
            name="ReduxActionScreen"
            component={ReduxActionScreen}
          />
          <Stack.Screen
            name="ReduxPenderScreen"
            component={ReduxPenderScreen}
          />
          <Stack.Screen name="ReduxSagaScreen" component={ReduxSagaScreen} />
          <Stack.Screen
            name="NativeModuleScreen"
